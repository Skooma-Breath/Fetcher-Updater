...
try {
    ...
    if ([int]$managedCompatibilityManifest.formatVersion -ne 1 -or
        [string]$managedCompatibilityManifest.patchVersion -ne "2026.09.14.1") {
    ...
    $expectedManagedOutputs = [ordered]@{
        ...
        "Data Files/fetcher-simulator/Quests/DevilishTouchOfMadness/scripts/devilish_actor_combat_probe.lua" = "f2143cac1a2d2be892fb8edba25050ca390aefe81e5affd7223f9081f65048b1"
